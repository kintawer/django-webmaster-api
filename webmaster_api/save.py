...
class Data:
    ...
    def __init__(self):
        self.OAUTH_TOKENS = ['AQAAAAAMklYVAAUuDS0h8BCqPUSRgLqzxnHPmP4', 'AQAAAAAp-rK8AAUxIb1CTRnMxUmNorPA4DhQUTY']
    ...
    def get_problems(self, user_id, host_id, SESSION):
        """
    ...
    def get_sitemap(self, user_id, host_id, SESSION):
        '''
        ...
        for sitemap in content['sitemaps']:
            if 'sitemap.xml' in sitemap['sitemap_url']:
                ...
                break
        return sitemap_date, sitemap_url_count

    def get_searchable(self, user_id, host_id, SESSION):
        '''
    ...
    def get_data(self):
        ...
        for OAUTH_TOKEN in self.OAUTH_TOKENS:
            ...
            for host_id in host_ids:
                ...
                info = {}
                problems = self.get_problems(user_id, host_id, SESSION)
                sitemap_date, sitemap_url_count = self.get_sitemap(user_id, host_id, SESSION)
                searchable_date, searchable_count = self.get_searchable(user_id, host_id, SESSION)
                ...
                if table is None:
                    Table.objects.create(
                        domain=domain,
                        fatal=problems['FATAL'],
                        critical=problems['CRITICAL'],
                        possible_problem=problems['POSSIBLE_PROBLEM'],
                        recommendation=problems['RECOMMENDATION'],
                    ...
                    table.fatal=problems['FATAL']
                    table.critical=problems['CRITICAL']
                    table.possible_problem=problems['POSSIBLE_PROBLEM']
                    table.recommendation=problems['RECOMMENDATION']
                    table.sitemap_date=sitemap_date
                    table.sitemap_url_count=sitemap_url_count
                    table.searchable_date=searchable_date
                    table.searchable_count=searchable_count
                    table.save()
